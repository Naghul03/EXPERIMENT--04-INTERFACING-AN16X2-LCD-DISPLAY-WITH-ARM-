...
{
  Lcd_cursor(&lcd, 0, 1);
  Lcd_string(&lcd, "Naghul varshan");

  Lcd_cursor(&lcd, 1, 1);
  Lcd_string(&lcd, "212224230173");
}
...
## Output screen shots of proteus  :
 <img width="1919" height="1138" alt="image" src="https://github.com/user-attachments/assets/4a55b51e-024f-44e5-a42c-3b043e12cd4c" />

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="1193" height="904" alt="image" src="https://github.com/user-attachments/assets/1bb6d634-547b-4ede-882a-4bcaa4b90784" />
